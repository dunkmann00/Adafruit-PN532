...
class Adafruit_PN532{
 public:
  ...
  bool listenForPassiveTarget(uint8_t cardbaudrate);
  bool getPassiveTargetID(uint8_t * uid, uint8_t * uidLength);
  ...
  // Low level communication functions that handle both SPI and I2C. Moved from private declaration.
  bool isready();
